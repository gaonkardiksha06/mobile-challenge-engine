...
export default function SignupScreen() {
  ...
  const handleSignup = async () => {
    if (!validate()) return;
    await login({ email: email.trim(), username: username.trim() });
  ...
  return (
    <View style={styles.container} testID="signup-screen">
      ...
      <Pressable style={styles.button} onPress={handleSignup} testID="signup-submit">
        <Text style={styles.buttonText}>Create account</Text>
      </Pressable>
      <Pressable onPress={() => router.back()} testID="go-login">
