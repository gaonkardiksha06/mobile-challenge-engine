...
Complete all tasks for **Expense Tracker** in the course project. Work on this challenge only until you pass review (≥ 80%).
...
npm run review -- --challenge=07-expense-tracker
```
