...
Complete all tasks for **Social Media Platform** in the course project. Work on this challenge only until you pass review (≥ 80%).
...
1. Feed, likes, comments
2. Profile and image upload
...
npm run review -- --challenge=11-social-media-platform
```
