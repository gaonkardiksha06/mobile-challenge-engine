# Challenge: Meme Viewer

**Course:** Challenge Missions
**Tier:** beginner


## Goal

Complete all tasks for **Meme Viewer** in the course project. Work on this challenge only until you pass review (≥ 80%).
...
1. Fetch memes from API
2. Vertical scroll gallery
...
```bash
cd courses/06-challenge-missions/project
npm run review -- --challenge=05-meme-viewer
```
