...
Complete all tasks for **Food Delivery** in the course project. Work on this challenge only until you pass review (≥ 80%).
...
npm run review -- --challenge=10-food-delivery
```
