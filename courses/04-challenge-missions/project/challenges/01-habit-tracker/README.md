...
Complete all tasks for **Habit Tracker** in the course project. Work on this challenge only until you pass review (≥ 80%).
...
npm run review -- --challenge=01-habit-tracker
```
