...
Complete all tasks for **AI Recipe App** in the course project. Work on this challenge only until you pass review (≥ 80%).
...
npm run review -- --challenge=09-ai-recipe-app
```
