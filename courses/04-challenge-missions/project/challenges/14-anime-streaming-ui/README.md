...
Complete all tasks for **Anime Streaming UI** in the course project. Work on this challenge only until you pass review (≥ 80%).
...
npm run review -- --challenge=14-anime-streaming-ui
```
