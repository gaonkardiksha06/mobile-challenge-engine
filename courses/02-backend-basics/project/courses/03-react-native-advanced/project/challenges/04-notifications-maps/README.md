# Challenge: Notifications & Maps

**Course:** Advanced React Native

## Goal

Complete all tasks for **Notifications & Maps** in the course project. Work on this challenge only until you pass review (≥ 80%).
...
2. Maps with static marker and user location
...
npm run review -- --challenge=04-notifications-maps
```
