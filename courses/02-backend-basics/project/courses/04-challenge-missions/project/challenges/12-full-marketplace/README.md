...
Complete all tasks for **Full Marketplace** in the course project. Work on this challenge only until you pass review (≥ 80%).
...
npm run review -- --challenge=12-full-marketplace
```
