...
Complete all tasks for **Realtime Chat** in the course project. Work on this challenge only until you pass review (≥ 80%).
...
1. Auth
2. Send/receive messages in realtime
...
npm run review -- --challenge=06-realtime-chat
```
