...
Complete all tasks for **Firebase** in the course project. Work on this challenge only until you pass review (≥ 80%).
...
1. Signup and login with Firebase Auth
2. Firestore chat (save/fetch messages)
3. Upload profile image to Storage
...
npm run review -- --challenge=03-firebase
```
