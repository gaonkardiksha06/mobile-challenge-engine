...
Complete all tasks for **MongoDB** in the course project. Work on this challenge only until you pass review (≥ 80%).
...
2. User schema (username, email, password)
3. Create, update, delete user
...
npm run review -- --challenge=03-mongodb
```
